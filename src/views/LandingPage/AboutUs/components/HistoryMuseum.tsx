...
interface HistoryMuseumProps{
    handleBack: () => void;
}

const HistoryMuseum: React.FC<HistoryMuseumProps> = ({ handleBack }) => {
    return(
        <Box>
            ...
            >
                <Typography fontWeight={700} fontSize={{ xs: '16px', md: '25px'}}>Lịch sử ra đời của bảo tàng</Typography>
