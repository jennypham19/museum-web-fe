...
const DetailMaterial: React.FC<DetailMaterialProps> = ({ handleBack }) => {
    return (
        <Box>
            <Box display='flex' flexDirection='row' py={{ xs: 0, md: 1.5}} px={{ xs: 2, md: 10}}>
                ...
                />
                <Typography mt={{ xs: 1, md: 1}} fontWeight={600} fontSize={{ xs: '12px', md: '18px'}}>/ About us/ Chính sách tài liệu/ Bài viết</Typography>
            </Box>
            <Box
                sx={{
            ...
            >
                <Typography fontWeight={700} fontSize={{ xs: '16px', md: '25px'}}>tài liệu số 001</Typography>
